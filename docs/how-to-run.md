...
6) Add IPs from the **IP Assets** page. In IP create/edit forms, use the Host search box above the Host selector to filter large host lists before assigning OS/BMC addresses.
