...
- After saving from the range addresses drawer, the page returns to the addresses view without hash-anchor jumps and restores the previous scroll position, matching the smoother `/ui/ip-assets` edit flow.
