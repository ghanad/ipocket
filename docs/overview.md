...
- Host deletion from the list now uses the same right-side drawer pattern and destructive confirmation layout as IP asset delete, including the same summary block styling, acknowledgement checkbox, and exact-name confirmation input.
