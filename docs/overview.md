...
- Hosts page includes a collapsible search panel with text search plus Vendor, Project, Assignment, linked/free Status, and tag filters. Text and select filters apply with HTMX table updates instead of a full page reload, and tag filters match tags on linked active IP assets.
